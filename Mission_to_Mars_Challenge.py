{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[WDM] - Driver [C:\\Users\\Admin\\.wdm\\drivers\\chromedriver\\win32\\95.0.4638.54\\chromedriver.exe] found in cache\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "<div class=\"fancybox-overlay fancybox-overlay-fixed\" style=\"width: auto; height: auto; display: block;\"><div class=\"fancybox-wrap fancybox-desktop fancybox-type-image\" style=\"width: 670px; height: 380px; position: absolute; top: 74px; left: 174px; opacity: 0.104292; overflow: hidden;\" tabindex=\"-1\"><div class=\"fancybox-skin\" style=\"padding: 15px; width: auto; height: auto;\"><div class=\"fancybox-outer\"><div class=\"fancybox-inner\" style=\"overflow: visible; width: 640px; height: 350px;\"><img alt=\"\" class=\"fancybox-image\" src=\"image/featured/mars2.jpg\"/></div></div></div></div></div></body></html>"
      ]
     },
     "execution_count": 11,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    "# Parse the HTML\n",
    "title = mrs_img.find_all('h3')\n",
    "title[0].text\n",
    "# img_url = mrs_img.find_all('img', class_='thumb')\n",
    "# for urls in img_url:\n",
    "    # print(urls['src'])"
   ]
  },
  {
   ...
   "source": [
    ...
    "    # browser.find_by_text('result-list')\n",
    "    \n",
    "    # Parse the HTML\n",
    "    html = browser.html\n",
    "\n",
